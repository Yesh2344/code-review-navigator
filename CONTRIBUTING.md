# Contributing to code-review-navigator
...
If you just need a language for your own repo, you may not need to contribute at all: drop a `.code-review-navigator/languages.toml` into your project mapping extensions and node types to any grammar in tree-sitter-language-pack — see [docs/CUSTOM_LANGUAGES.md](docs/CUSTOM_LANGUAGES.md). To add built-in support upstream:
...
- Open an issue via the issue forms: https://github.com/your-github-username/code-review-navigator/issues/new/choose (bug report, feature request, or platform request — blank issues are disabled)
- For questions and ideas, use GitHub Discussions instead: https://github.com/your-github-username/code-review-navigator/discussions
