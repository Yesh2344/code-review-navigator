...
def _legacy_repo_hook_commands(repo_root: Path) -> set[str]:
    ...
    return {
        ...
        (
            "git rev-parse --git-dir >/dev/null 2>&1"
            f" && code-review-navigator status --repo {repo_arg}"
...
def _remove_hooks(
    ...
    *,
    ...
    _write_text(
        ...
        rewritten,
        report,
        detail="removed code-review-navigator hook entries",
        dry_run=dry_run,
    )
    ...
    *,
    ...
    if rewritten:
        _write_text(
            ...
            rewritten,
            report,
            detail="removed code-review-navigator instruction section",
            dry_run=dry_run,
        )
    else:
        _remove_file(
    ...
    *,
    ...
    if meaningful:
        _write_text(
            ...
            new_text,
            report,
            detail="removed code-review-navigator hook block",
            dry_run=dry_run,
        )
    else:
        _remove_file(
            ...
            report,
            dry_run=dry_run,
            detail="remove hook containing only code-review-navigator",
        )
    ...
    *,
    ...
    while index < len(lines):
        if (
            ...
            and lines[index + 1].strip() in {".code-review-navigator", ".code-review-navigator/"}
        ):
            changed = True
            index += 2
            continue
...
def _process_repo(
    ...
    *,
    ...
    data_paths = [
        (repo_root / ".code-review-navigator", "tree"),
        (repo_root / ".code-review-navigator.db", "file"),
        (repo_root / ".code-review-navigator.db-wal", "file"),
        (repo_root / ".code-review-navigator.db-shm", "file"),
    ]
...
def _process_user(
    ...
    *,
    ...
    user_data = home / ".code-review-navigator"
    if keep_data:
...
def _registry_repo_paths(home: Path, report: UninstallReport) -> list[Path]:
    path = home / ".code-review-navigator" / "registry.json"
