#!/usr/bin/env python3
"""Generate 9 Excalidraw diagrams for code-review-navigator Medium article.
...
def d6():
    ...
    gcx = gx + (cols*gapx)/2
    els.append(TC(gcx, gy-35, "code-review-navigator", 22, sc=DRK))
    ...
    fcx = fx + fw/2
    els.append(TC(fcx, fy+25,  "code-review-navigator", 17, sc=PRP))
...
def d7():
    ...
    els.append(TC(sx+bw/2, y+38, "code-review-navigator serve", 13, sc=GRY))
...
def d8():
    ...
    els.append(TC(600, 70, "code-review-navigator install", 20, sc=PRP, ff=3))
