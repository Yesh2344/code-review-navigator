...
The extension requires the `code-review-navigator` Python CLI to parse your codebase.

```bash
# Recommended
uv pip install code-review-navigator
...
The graph database is stored locally at `.code-review-navigator/graph.db` and updates automatically on file save.
...
- [Main Repository](https://github.com/your-github-username/code-review-navigator)
- [Report an Issue](https://github.com/your-github-username/code-review-navigator/issues)
