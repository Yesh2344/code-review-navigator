...
### Full Build
1. `collect_all_files()` gathers tracked files (`git ls-files`) and applies `.code-review-navigatorignore` (gitignored files are skipped automatically when git is available)
