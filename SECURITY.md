...
2. Use [GitHub private vulnerability reporting](https://github.com/your-github-username/code-review-navigator/security/advisories/new)
...
code-review-navigator is a **local development tool**. It:
- Runs as a local MCP server via stdio or localhost-bound streamable HTTP
- Stores data in a local SQLite database (`.code-review-navigator/graph.db`)
...
| Path Traversal | `_validate_repo_root()` requires `.git`, `.svn`, or `.code-review-navigator` directory |
