...
class TestEnrichSearch:
    def setup_method(self):
        ...
        self.db_dir = Path(self.tmpdir) / ".code-review-navigator"
        self.db_dir.mkdir()
    ...
    def test_returns_matching_symbols(self):
        ...
        assert "[code-review-navigator]" in result
...
class TestRunHookOutput:
    ...
    def test_hook_json_format(self):
        ...
        db_dir = Path(tmpdir) / ".code-review-navigator"
        db_dir.mkdir()
        ...
        assert result.startswith("[code-review-navigator]")
