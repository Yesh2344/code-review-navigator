#!/usr/bin/env python3
"""Render a risk-scored PR comment from ``code-review-navigator detect-changes`` JSON.

Reads the JSON document printed by ``code-review-navigator detect-changes
...
MARKER = "<!-- code-review-navigator-report -->"
REPO_URL = "https://github.com/your-github-username/code-review-navigator"
FOOTER = (
    f"*Powered by [code-review-navigator]({REPO_URL}) — "
...
def render_markdown(
    ...
    *,
    ...
    lines: list[str] = [MARKER, "", "## code-review-navigator review", ""]
    lines.append(
