...
- The graph is stored as a SQLite database (`.code-review-navigator/graph.db`) in the repo root
- Binary files, generated files, and patterns in `.code-review-navigatorignore` are skipped
